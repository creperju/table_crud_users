...
namespace core {
	...
	class Configuracion {
		...
		public static $session_name = "TABLECRUDUSERID";
		...
		public static $sesion_minutos_inactividad = 5; // num >= 0. 0 Implica sin control
		public static $sesion_minutos_maxima_duracion = 10; // Duración máxima de una conexión. 0 Implica sin control.
