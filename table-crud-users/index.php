...
// Busca en un array, que contiene las distintas aplicaciones
// como carrito_ajax, carrito, etc.
// EXPLICADO DE MEJOR FORMA EN LOS APUNTES DEL 7-3-14

/* Para indicar más aplicaciones donde buscar los ficheros no existentes...
 * APPLICATION_FOLDER es la aplicación actual desde donde se invoca este index.php
 * $autoloader = new \core\Autoloader(array(
 *                                          APPLICATION_FOLDER => true,
 *                                          "tienda_carrito_ajax" => true,
 *                                          "table-crud-users" => true)
 *                                   );
*/
